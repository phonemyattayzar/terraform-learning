...
```
- Reference the security groups in `ec2-instance.tf` file as a list item
```t
# List Item
...
```
- Reference the datasource in `ec2-instance.tf` file
```t
# Reference Datasource to get the latest AMI ID
ami = data.aws_ami.amzlinux2.id 
```

## Step-05: ec2-instance.tf - Define EC2 Instance Resource
