...
```t
terraform {
  required_version = "~> 1.15" # which means any version equal & above 0.14 like 0.15, 0.16 etc and < 1.xx
  required_providers {
    aws = {
...
sudo echo '<h1>Welcome From Hello World</h1>' | sudo tee /var/www/html/index.html
